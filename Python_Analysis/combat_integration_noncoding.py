...
input_path = "adatas_raw_noncoding_logcounts_before_combat.h5ad"
output_path = "adata_noncoding_combat_all_genes_umap_leiden.h5ad"
...
# --- Guardar
adatas_full_combat.write('adata_noncoding_combat_celltypist_final.h5ad', compression="gzip")
...
adatas_full_combat.write(
    "adata_noncoding_combat_celltypist_final_final.h5ad",
    compression="gzip"
)
...
print("✅ Terminado.")
print("Objeto final guardado en: adata_noncoding_combat_celltypist_final.h5ad")
print("Objeto final adicional guardado en: adata_noncoding_combat_celltypist_final_final.h5ad")
